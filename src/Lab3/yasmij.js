    ...
    return (function e(t, n, r) {
    ...
    })(
        {
            1: [
                ...
                {
                    "./src/YASMIJ.Constraint.js": 2,
                    "./src/YASMIJ.Expression.js": 3,
                    "./src/YASMIJ.Input.js": 4,
                    "./src/YASMIJ.Matrix.js": 5,
                    "./src/YASMIJ.Output.js": 6,
                    "./src/YASMIJ.Simplex.js": 7,
                    "./src/YASMIJ.Tableau.js": 8,
                    "./src/YASMIJ.base.js": 9
                }
            ],
            2: [
                function (require, module, exports) {
                    ...
                    Constraint.hasManyCompares = function (str) {
                        var RE_compares = /[<>]=?|=/g;
                        var matches =
                            ("" + str).replace(/\s/g, "").match(RE_compares) ||
                            [];
                    ...
                    Constraint.hasIncompleteBinaryOperator = function (str) {
                        ...
                        var noSpaceStr = ("" + str).replace(/\s/g, ""),
                            hasNoOperatorBetweenValues =
                                /[^+\-><=]\s+[^+\-><=]/.test("" + str),
                            RE_noLeftAndRightTerms = /[+\-][><=+\-]|[><=+\-]$/;

                        return (
                            RE_noLeftAndRightTerms.test(noSpaceStr) ||
                            hasNoOperatorBetweenValues
                        );
                    };
                    /**
                    ...
                    Constraint.getErrorMessage = function (str) {
                        ...
                        if (Constraint.hasManyCompares(str)) {
                            errMsg =
                                "Only 1 comparision (<,>,=, >=, <=) is allow in a Constraint.";
                        }
                        if (
                            !errMsg &&
                            Constraint.hasIncompleteBinaryOperator(str)
                        ) {
                            errMsg =
                                "Math operators must be in between terms. Good:(a+b=c). Bad:(a b+=c)";
                        }
                        return errMsg;
                    };
                    /**
                     ...
                     */
                    Constraint.switchSides = function (
                        sideA,
                        sideB,
                        forEachTermFunc
                    ) {
                    ...
                    Constraint.prototype.getTermNames = function (
                        ...
                        var arr = [].concat(
                            this.leftSide.getTermNames(excludeNumbers),
                            this.rightSide.getTermNames(excludeNumbers)
                        );
                     ...
                     * @example
                     */
                    Constraint.prototype.moveTypeToOneSide = function (
                        varSide,
                        numSide
                    ) {
                        var varSides, numSides;

                        if (/left|right/.test(varSide)) {
                            varSides = this.getSwappedSides(
                                /left/.test(varSide)
                            );
                            Constraint.switchSides(
                                varSides.a,
                                varSides.b,
                                varSides.a.forEachVariable
                            );
                        }
                        if (/left|right/.test(numSide)) {
                            numSides = this.getSwappedSides(
                                /left/.test(numSide)
                            );
                            Constraint.switchSides(
                                numSides.a,
                                numSides.b,
                                numSides.a.forEachConstant
                            );
                        }
                        return this;
                    };
                    ...
                    Constraint.prototype.setSpecialTerm = function (obj) {
                        ...
                        this.leftSide.setTerm(
                            this.specialTerms[obj.key].name,
                            +obj.value
                        );
                        return this;
                    };
                    ...
                    Constraint.prototype.getSpecialTermNames = function () {
                        ...
                        for (var prop in this.specialTerms) {
                            if (
                                this.specialTerms.hasOwnProperty(prop) &&
                                this.specialTerms[prop]
                            ) {
                     ...
                     * @chainable
                     */
                    Constraint.prototype.varSwitchSide = function (
                        name,
                        moveTo
                    ) {
                     ...
                     */
                    Constraint.prototype.getCoefficients = function (
                        termNames
                    ) {
                        if (!termNames) {
                            return null;
                     ...
                     * @return {Array} - Array of numbers
                     */
                    Constraint.prototype.getTermValuesFromLeftSide = function (
                        termNames
                    ) {
                        if (!termNames) {
                            return null;
                        ...
                        while (i--) {
                            val = this.leftSide.getTermValue(termNames[i]);
                            if (val === undefined) {
                                val = -this.rightSide.getTermValue(
                                    termNames[i]
                                );
                            }
                            arr[i] = val || 0;
            ...
            3: [
                function (require, module, exports) {
                    ...
                    Expression.hasIncompleteBinaryOperator = function (str) {
                        ...
                        hasError =
                            hasMoreThanOneTerm &&
                            RE_hasNoPlusOrMinus.test(noSpaceStr);
                        hasError =
                            hasError || RE_noLeftAndRightTerms.test(noSpaceStr);
                        return hasError;
                    };
                    /**
                    ...
                    Expression.getErrorMessage = function (str) {
                        ...
                        if (Expression.hasComparison(str)) {
                            errMsg =
                                "Comparison are not allowed within an expression.";
                        }
                        if (!errMsg && Expression.hasExcludedOperations(str)) {
                            errMsg =
                                "Addition and subtraction are only supported.";
                        }
                        if (
                            !errMsg &&
                            Expression.hasIncompleteBinaryOperator(str)
                        ) {
                            errMsg =
                                "Exactly one math operators must be between terms.\n Good:(a+b). Bad:(a++ b+).";
                        }
                        if (errMsg) {
                            errMsg += "\n Input: `" + str + "`";
                        }
                    ...
                    Expression.convertExpressionToObject = function (str) {
                        var term,
                            obj = {},
                            matches = Expression.splitStrByTerms(
                                (str || "").trim()
                            ),
                            i = matches.length;
                        while (i--) {
                            term = Expression.extractComponentsFromVariable(
                                matches[i]
                            );
                            if (!term[0]) {
                                term = [0, 1];
                            }
                            obj[term[1]] = obj[term[1]]
                                ? obj[term[1]] + term[0]
                                : term[0];
                        }
                        return obj;
 ...
 */
                    ...
                    Expression.prototype.getTermNames = function (
                        ...
                        for (key in obj) {
                            if (
                                ...
                                (excludeSlack && RE_slack.test(key))
                            ) {
                                continue;
                            }
                            if (isNaN(key)) {
                    ...
                    Expression.prototype.forEachVariable = function (fn) {
                        ...
                        for (var prop in this.terms) {
                            if (
                                this.terms.hasOwnProperty(prop) &&
                                prop !== "1"
                            ) {
                                fn(prop, this.terms[prop], this.terms);
                            }
                     ...
                     * @example
                     */
                    Expression.prototype.getAllCoeffients = function (
                        excludeNumbers,
                        excludeSlack
                    ) {
                        var arr = [];
                     ...
                     * @example
                     */
                    Expression.prototype.getCoefficients = function (
                        termNames
                    ) {
                        var arr = [],
                            i = termNames.length;
            ...
            4: [
                function (require, module, exports) {
                    ...
                    Input.parse = function (type, z, constraints) {
                        ...
                        obj.constraints =
                            YASMIJ.Input.getArrOfConstraints(constraints);
                        obj.setTermNames();
                    ...
                    Input.getErrors = function (type, z, constraints) {
                        ...
                        if (type !== "maximize" && type !== "minimize") {
                            errMsgs.push(
                                "`maximize` and `minimize` are the only types that is currently supported."
                            );
                        }
                        if (
                            !YASMIJ.Matrix.isArray(constraints) ||
                            !constraints.length
                        ) {
                            errMsgs.push(
                                "Constraints must be an array with at least one element."
                            );
                        }
                        return errMsgs;
                    };
                    ...
                    Input.prototype.computeType = function () {
                        ...
                        if (/max/.test(this.type)) {
                            return hasGreaterThan
                                ? YASMIJ.CONST.NONSTANDARD_MAX
                                : YASMIJ.CONST.STANDARD_MAX;
                        }
                        if (/min/.test(this.type)) {
                            return hasLessThan
                                ? YASMIJ.CONST.NONSTANDARD_MIN
                                : YASMIJ.CONST.STANDARD_MIN;
                        }
                    };
                    /**
                     ...
                     * @return {Boolean}
                     */
                    Input.prototype.doAnyConstrainsHaveRelation = function (
                        comparison
                    ) {
                        if (!comparison) {
                            return false;
                     ...
                     * @return {Boolean}
                     */
                    Input.prototype.doAllConstrainsHaveRelation = function (
                        comparison
                    ) {
                        comparison = new RegExp(comparison);
                    ...
                    Input.prototype.getTermNames = function (onlyVariables) {
                        ...
                        while (i--) {
                            vars = vars.concat(
                                this.constraints[i].getTermNames(onlyVariables)
                            );
                        }
                    ...
                    Input.prototype.getZTermNotInAnyOfTheConstraints =
                        function () {
                            var varMissing = "",
                            ...
                            for (; !varMissing && i < iLen; i++) {
                                term = terms[i];
                                for (
                                    var j = 0, jLen = this.constraints.length;
                                    j < jLen;
                                    j++
                                ) {
                                    if (
                                        this.constraints[j].leftSide.terms[term]
                                    ) {
                                        break;
                                    }
                                }
 ...
 */
                    Matrix.scaleThenAddRows = function (
                        scaleA,
                        rowA,
                        scaleB,
                        rowB
 ...
 */
                    Matrix.getGreatestElementInRow = function (
                        arr,
                        excludeIndex,
                        findPositive
                    ) {
                        ...
                        for (var i = 0, len = arr.length; i < len; i++) {
                            ...
                            if (
                                (findPositive && obj.value < arr[i]) ||
                                (!findPositive && arr[i] < obj.value)
                            ) {
                                obj.index = i;
                                obj.value = arr[i];
                            }
 ...
 */
                    Matrix.prototype.getGreatestValueFromLastRow = function (
                        isPositive
                    ) {
                        ...
                        var obj = Matrix.getGreatestElementInRow(
                            row,
                            row.length - 1,
                            !!isPositive
                        );
 ...
 */
                    Matrix.prototype.getRowIndexWithPosMinColumnRatio =
                        function (colI, excludeLastRow) {
                            var obj = {
                                    rowIndex: -1,
                                    minValue: Infinity
                                },
 ...
 */
                    Matrix.prototype.addToRow = function (iRow, els) {
                        if (this.array[iRow]) {
                            this.array[iRow] = (this.array[iRow] || []).concat(
                                els
                            );
                        } else {
                            this.addRow(els);
 ...
 */
                    Matrix.prototype.pivot = function (rowI, colI) {
                        ...
                        for (var i = 0, len = this.array.length; i < len; i++) {
                            ...
                            this.array[i] = Matrix.scaleThenAddRows(
                                -val,
                                pRow,
                                1,
                                this.array[i]
 ...
 */
            ...
            8: [
                function (require, module, exports) {
                    ...
                    Tableau.getPivotPoint = function (matrix, isMin) {
                        ...
                        var point = {};
                        point.column = matrix.getGreatestValueFromLastRow(
                            !!isMin
                        );
                        var obj =
                            matrix.getRowIndexWithPosMinColumnRatio(
                                point.column,
                                true
                            ) || {};
                    ...
                    Tableau.prototype.addConstraintsToMatrix = function (
                        termNames
                    ) {
                        var constraints = this.input.constraints;
                        for (
                            var i = 0, len = constraints.length;
                            i < len;
                            i++
                        ) {
                            this.matrix.addRow(
                                constraints[i].getCoefficients(termNames)
                            );
                        }
                    };
                    Tableau.prototype.getSortedTermNames = function () {
                        ...
                        return YASMIJ.sortArrayWithSubsetAtEnd(
                            termNames,
                            specialNames
                        );
                    };
                    ...
                    Tableau.prototype.addZToMatrix = function (termNames) {
                        var b = YASMIJ.Constraint.parse(
                            "0 = " + this.input.z.toString()
                        );
                    ...
                    Tableau.prototype.toString = function () {
                        ...
                        if (this.matrix) {
                            result +=
                                "[" +
                                this.colNames.concat("Constant").toString() +
                                "],";
                    ...
                    Tableau.prototype.getOutput = function () {
                        ...
                        for (var i = 0, len = names.length; i < len; i++) {
                            obj[names[i]] =
                                this.matrix.getUnitValueForColumn(i);
                        }
                ...
                function (require, module, exports) {
                    ...
                    module.exports =
                        ...
                        (function () {
                             ...
                             * @return {Object}
                             */
                            YASMIJ.convertArrayValuesToHashMap = function (
                                arr
                            ) {
                                if (!arr || typeof arr !== "object") {
                                    return {};
     ...
     */
                            YASMIJ.sortArrayWithSubsetAtEnd = function (
                                arr,
                                subset
                            ) {
                                if (
                                ...
                                var list = [];
                                var hash =
                                    YASMIJ.convertArrayValuesToHashMap(subset);
                                for (
                                    var i = 0, len = arr.length;
                                    i < len;
                                    i++
